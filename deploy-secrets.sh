...
if [ ! -z "$G2PAY_HOSTED_URL" ]; then
    ...
    echo "✅ Using custom G2PAY_HOSTED_URL"
else
    echo "ℹ️  G2PAY_HOSTED_URL not set (will use default: https://checkout.g2pay.co.uk/postbridge/g2paymodal)"
fi
...
echo "   ✓ G2PAY_HOSTED_URL - G2Pay hosted page URL (for Apple Pay validation)"
...
echo "     - Apple Pay (direct integration)"
echo "     - Google Pay (direct integration)"
echo "   • Apple Pay merchant validation via G2Pay Hosted URL"
