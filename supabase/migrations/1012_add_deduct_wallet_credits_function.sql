-- ============================================
-- ADD DEDUCT WALLET CREDITS FUNCTION
-- Description: Deduct wallet credits from user's balance (FIFO)
-- Date: 2026-04-06
-- ============================================
...
GRANT EXECUTE ON FUNCTION public.deduct_wallet_credits(UUID, INTEGER, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION public.deduct_wallet_credits(UUID, INTEGER, UUID) TO service_role;
